...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"ShowSelectedMovie"]) {
        ...
        [vc setUsername:[NSString stringWithFormat:@"%@", [username objectAtIndex:selectedIndex]]];
        [vc setDistance:[NSString stringWithFormat:@"%@", [distance objectAtIndex:selectedIndex]]];
